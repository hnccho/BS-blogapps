...
public class LRUCache {
     ...
     */
    public LRUCache(int maxsize, long timeout) {
     ...
     */
    public LRUCache(Environment environment, int maxsize, long timeout) {
    ...
    public synchronized Object get(String key) {
        ...
        if (entry != null) {
            if (environment.getCurrentTimeInMillis() - entry.getTimeCached() < timeout*1000) {

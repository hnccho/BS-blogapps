...
public class AtomService {
    ...
    public static class Collection {
        ...
        /**
         * Accept is "entry" or comma-separated list of acceptible content 
         * these (formatted like an HTTP accepts header)
         */
    ...
    public static AtomService documentToService(Document document) throws BlogClientException {
        AtomService service = new AtomService();
        Element root = document.getRootElement();
        if (!"service".equals(root.getName())) {
            throw new BlogClientException("Not an introspection document");
        }
    ...
    public static AtomService.Collection elementToCollection(Element element) {
        ...
        if (memberType != null) {
            collection.Accept(memberType.getText());
        }
        return collection;
    }
